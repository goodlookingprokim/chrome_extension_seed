...
이 저장소는 **전통적인 방법**으로 크롬 확장 프로그램을 만드는 방법을 배우는 분들을 위한 **기본 씨앗 파일**을 제공합니다. 프레임워크 없이 순수 HTML/CSS/JavaScript만으로 확장 프로그램을 만들 수 있어요!
...
*이 가이드는 4060 미들스쿨 주니어 개발자를 응원하기 위해 만들어졌습니다.*
